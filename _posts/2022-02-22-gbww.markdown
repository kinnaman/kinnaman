...
The best versions are found on sites like Amazon or Libby (a free online library). Most of the texts are in the public domain so in order to aqcuire them in Shadow Libraries or Gutenberg is an option if money or access to Libby is an issue. 
